...
function ContentPanel({ activeSection, hoveredCardIdx, setHoveredCardIdx, setExpandedImg }: {
  ...
  return (
    <div className="w-full md:ml-[35%] md:w-[65%] min-h-screen p-4 md:p-8 overflow-y-auto">
      <div
        id="experience"
        className={`flex flex-col gap-8 md:pt-8 transition-opacity duration-300 ${activeSection === 'experience' ? 'opacity-100' : 'opacity-0 hidden'}`}
      >
        {[
          {
      ...
      >
        ...
        >
          ...
          <a
            ...
            className="text-blue-400 underline hover:text-blue-300 mb-2 inline-block"
          >
            View on GitHub
          </a>
